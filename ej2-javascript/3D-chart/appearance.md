...
description: Learn how to customize the appearance of the Syncfusion ##Platform_Name## 3D Chart using palettes, background, border, animation, and title.
...
# Appearance in ##Platform_Name## 3D Chart
