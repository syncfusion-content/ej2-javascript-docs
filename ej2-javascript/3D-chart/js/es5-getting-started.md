---
layout: post
title: Getting Started with ##Platform_Name## 3D Chart (ES5) | Syncfusion
description: Learn how to get started with the Syncfusion ##Platform_Name## 3D Chart in an ES5 application using the CDN approach.
