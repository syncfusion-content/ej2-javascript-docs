...
description: Learn how to render the Syncfusion ##Platform_Name## 3D Chart with a logarithmic axis to visualize data across many orders of magnitude.
...
# Logarithmic Axis in ##Platform_Name## 3D Chart
