...
description: Learn how to render the Syncfusion ##Platform_Name## 3D Chart with a numeric axis to represent numeric values along an axis.
...
# Numeric Axis in ##Platform_Name## 3D Chart
