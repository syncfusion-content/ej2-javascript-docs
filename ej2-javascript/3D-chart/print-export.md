...
description: Learn how to print and export the Syncfusion ##Platform_Name## 3D Chart from the browser using the built-in print method.
...
# Print and Export in ##Platform_Name## 3D Chart
