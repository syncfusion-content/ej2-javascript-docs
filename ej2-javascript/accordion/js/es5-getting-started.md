---
layout: post
title: Es5 getting started with ##Platform_Name## Accordion | Syncfusion
description: Learn how to render the Syncfusion ##Platform_Name## Accordion in ES5 JavaScript using the global script, JSON items, or HTML markup.
...
# Es5 getting started in ##Platform_Name## Accordion
...
**Step 3:** Create a HTML page (index.html) in `myapp` location and add the CDN link references. Now, add the `Accordion` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 Accordion** component in the index.html by using following code.
