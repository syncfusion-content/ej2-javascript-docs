...
description: Migrate Accordion APIs from Essential JS 1 to Essential JS 2 with this Syncfusion ##Platform_Name## reference table.
...
# Ej1 api migration in ##Platform_Name## Accordion
