...
* The [promptRequest](https://ej2.syncfusion.com/documentation/api/ai-assistview/aiassistviewmodel#promptrequest) event sends the user prompt to the LiteLLM proxy at `/v1/chat/completions`.
...
{% include code-snippet/ai-assistview/ai-integrations/lite-llm/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/ai-assistview/ai-integrations/lite-llm/ts/index.html %}
{% endhighlight %}
