...
description: Enable file attachments in the Syncfusion® ##Platform_Name## AI AssistView with upload endpoints, allowed file types, size limits, and max file count.
