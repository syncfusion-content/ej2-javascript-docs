...
description: Step-by-step setup for the Syncfusion® ##Platform_Name## AI AssistView in ES5, including CDN/local scripts, dependencies, and control initialization.
