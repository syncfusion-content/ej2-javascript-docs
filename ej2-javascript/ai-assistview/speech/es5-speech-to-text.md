...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/ai-assistview/speech/speech-configuration/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/ai-assistview/speech/tooltip-settings/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/ai-assistview/speech/speech-events/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
