...
## CSS themes - Syncfusion<sup style="font-size:70%">&reg;</sup> ##Platform_Name## Controls

The following themes are available with both **light** and **dark** variants:

- [Material 3](https://m3.material.io)  
- [Fluent 2](https://fluent2.microsoft.design/get-started/whatisnew)  
- [Bootstrap 5.3](https://getbootstrap.com/docs/5.3/getting-started/introduction)  
- [Tailwind 3.4](https://tailwindcss.com/docs/installation/using-vite)

These themes use CSS variables for easy color customization and seamless light/dark mode switching.
...
| CDN  | [Material 3 Light](https://cdn.syncfusion.com/ej2/34.2.2/material3.css)  |  [Material 3 Dark](https://cdn.syncfusion.com/ej2/34.2.2/material3-dark.css)  |
|  |  [Fluent 2 light](https://cdn.syncfusion.com/ej2/34.2.2/fluent2.css)  |  [Fluent 2 Dark](https://cdn.syncfusion.com/ej2/34.2.2/fluent2-dark.css)  |
|  |  [Bootstrap5.3 light](https://cdn.syncfusion.com/ej2/34.2.2/bootstrap5.3.css)  |  [Bootstrap 5.3 Dark](https://cdn.syncfusion.com/ej2/34.2.2/bootstrap5.3-dark.css)  |
|  | [Tailwind 3.4 Light](https://cdn.syncfusion.com/ej2/34.2.2/tailwind3.css) | [Tailwind 3.4 Dark](https://cdn.syncfusion.com/ej2/34.2.2/tailwind3-dark.css) |
...
Access the Syncfusion<sup style="font-size:70%">&reg;</sup> ThemeStudio application at: [Syncfusion<sup style="font-size:70%">&reg;</sup> ThemeStudio](https://ej2.syncfusion.com/themestudio/?theme=material3)
