...
The kits contain reusable design controls with various possible states and variants, along with detailed figures, measurements, and icons, representing the Syncfusion<sup style="font-size:70%">&reg;</sup> ##Platform_Name## controls.
...
Syncfusion’s<sup style="font-size:70%">&reg;</sup> Figma UI kit is structured to offer a comprehensive and user-friendly layout, facilitating easy navigation and exploration of various controls. It includes the following pages:
...
- **UI Controls**: At the core of the UI kit, this section features a wide range of Essential<sup style="font-size:70%">&reg;</sup> UI controls. Each control is meticulously designed with detailed figures, measurements, and icons, showcasing various states and variants.
