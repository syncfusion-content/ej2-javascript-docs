...
description: Set up a Syncfusion ##Platform_Name## AutoComplete in a plain ES5 JavaScript app using the global script and required dependencies.
...
**Step 5:** Now, add the `input` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 AutoComplete** component in the `index.html` by using following code
...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 AutoComplete** component.
...
**Step 3:** Create a HTML page (index.html) in `myapp` location and add the CDN link references. Now, add the `input` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 AutoComplete** component in the index.html by using following code.
...
**Step 4:** Now, run the `index.html` in web browser, it will render the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 AutoComplete** component.
