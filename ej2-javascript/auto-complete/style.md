...
description: Customize the appearance of Syncfusion ##Platform_Name## AutoComplete using the documented CSS structure for the wrapper, popup, list, and input.
...
{% include code-snippet/autocomplete/asterisk-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/autocomplete/asterisk-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/autocomplete/asterisk-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/autocomplete/asterisk-cs1/index.html %}
{% endhighlight %}
