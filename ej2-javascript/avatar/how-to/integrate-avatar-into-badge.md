...
description: Combine Syncfusion ##Platform_Name## Avatar with the Badge control to create notification avatars that show status indicators and unread counts.
...
# How to integrate avatar into badge in ##Platform_Name## Avatar
