...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/block-editor/blocks/block-types/table-block/table-feature/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/block-editor/blocks/block-types/table-block/table-feature/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/block-editor/blocks/block-types/table-block/table-feature/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/block-editor/blocks/block-types/table-block/table-feature/index.html %}
{% endhighlight %}
