...
description: Learn how to get started with the Syncfusion ##Platform_Name## Breadcrumb. Explore setup, features, examples, and customization options.
...
# Getting started in ##Platform_Name## Breadcrumb
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Breadcrumb package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Breadcrumb CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Breadcrumb control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Breadcrumb control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Breadcrumb control, add the following JavaScript code to the `~/src/app/app.ts` file
