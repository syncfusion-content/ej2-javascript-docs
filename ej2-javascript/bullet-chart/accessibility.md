---
layout: post
title: Accessibility in ##Platform_Name## Bullet chart control | Syncfusion
description: Learn here all about Accessibility in Syncfusion ##Platform_Name## Bullet chart control of Syncfusion Essential JS 2 and more.
