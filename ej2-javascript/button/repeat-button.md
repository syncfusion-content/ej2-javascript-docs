...
{% include code-snippet/button/repeat-button-cs2/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/button/repeat-button-cs2/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/button/repeat-button-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/button/repeat-button-cs2/index.html %}
{% endhighlight %}
