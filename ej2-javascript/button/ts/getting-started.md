...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Button package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Button CSS styles
...
@import "../../node_modules/@syncfusion/ej2-fluent2-theme/styles/button/index.css";
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Button control to the application

The Button can be initialized through input tags.
...
In this article, the Button control is used as an example. Add the following Button element to the `~/src/index.html` file.
