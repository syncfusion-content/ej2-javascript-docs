...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Calendar package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Calendar CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Calendar control to the application

The Calendar can be initialized through input tags.

Add the HTML input element which needs to be initialized as Calendar in `index.html`.

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript UI controls. 

In this article, the Calendar control is used as an example. Add the following Calendar element to the `~/src/index.html` file.
