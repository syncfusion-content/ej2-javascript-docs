...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Card packages
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Card control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript UI controls. 

In this article, the Card control is used as an example. Add the following Card element to the `~/src/index.html` file.
...
<body>
    ...
    <div class="e-card-header">
        <div class="e-card-header-caption">
            <div class="e-card-header-title">Welcome</div>
        </div>
    </div>
