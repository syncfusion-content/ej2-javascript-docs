...
For more details, see the [Series](./chart-types/line) section.
...
For more details, see the [Tooltip](./tool-tip) section.
...
For more details, see the [Legend](./legend) section.
