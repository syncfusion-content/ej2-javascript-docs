...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Syncfusion JavaScript (ES5) Chat UI** control.
...
**Step 4:** Now, run the `index.html` in web browser, it will render the `Syncfusion JavaScript Chat UI` control.
