...
description: Enable Speech-to-Text in the Syncfusion® ##Platform_Name## Chat UI (TypeScript) using the browser Web Speech API with custom language and interim results.
