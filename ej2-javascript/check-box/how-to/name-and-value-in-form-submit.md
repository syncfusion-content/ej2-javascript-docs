---
layout: post
title: How to set name and value in submit in ##Platform_Name## | Syncfusion
description: Learn how the ##Platform_Name## Checkbox name and value attributes post checked items to the server on form submit.
...
# How to set name and value in form submit in ##Platform_Name## Checkbox
