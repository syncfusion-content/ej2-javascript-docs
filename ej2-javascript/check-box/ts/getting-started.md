...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Check box package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Check box CSS styles
...
@import "../../node_modules/@syncfusion/ej2-fluent2-theme/styles/check-box/index.css";
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Check box control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Check box control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Check box control, add the following JavaScript code to the `~/src/app/app.ts` file
