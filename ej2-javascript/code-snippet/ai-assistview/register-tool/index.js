...
var scoreBlocks = [];
var weatherData = [ { blockType: "text", content: "Here is the current weather forecast for your location:" },
        ...
        <div class="recipe-panel e-card">
            ...
            <div class="recipe-section">
                ...
                <div class="instructions-list">
                    ${data.instructions.map(function (step) {
                        return `
                            <div class="step-item">
