...
(document.getElementById('setSelectionBtn')).addEventListener('click', () => {
...
(document.getElementById('setCursorBtn')).addEventListener('click', () => {
...
(document.getElementById('getSelectedBlocksBtn')).addEventListener('click', () => {
...
(document.getElementById('getRangeBtn')).addEventListener('click', () => {
...
// Select Block Method
(document.getElementById('selectBlockBtn')).addEventListener('click', () => {
