    ...
    series: [
        {
            ...
            type: 'StackingColumn100', name: 'UK', fill: 'url(#gradient1)'
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y1',
            type: 'StackingColumn100', name: 'Germany', fill: 'url(#gradient2)'
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y2',
            type: 'StackingColumn100', name: 'France', fill: 'url(#gradient3)'
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y3',
            type: 'StackingColumn100', name: 'Italy', fill: 'url(#gradient4)'
        }
    ],
