    ...
    series: [
        {
            ...
            type: 'StackingColumn100', name: 'UK', dashArray: '5,5',
            border: { width: 2, color: '#ff4251'}
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y1',
            type: 'StackingColumn100', name: 'Germany', dashArray: '5,5',
            border: { width: 2, color: '#4C4C4C'}
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y2',
            type: 'StackingColumn100', name: 'France', dashArray: '5,5',
            border: { width: 2, color: '#794F1B'}
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y3',
            type: 'StackingColumn100', name: 'Italy', dashArray: '5,5',
