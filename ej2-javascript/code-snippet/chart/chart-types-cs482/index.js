...
var chart = new ej.charts.Chart({
    ...
    series:[{
        ...
        marker: { visible: true },
        accessibility: {
            accessibilityDescription: 'Spline area chart representing monthly temperature variations.',
            accessibilityRole: 'series',
            accessibilityDescriptionFormat: 'Month: ${point.x}, Temperature: ${point.y}°C'
        }
    }],
