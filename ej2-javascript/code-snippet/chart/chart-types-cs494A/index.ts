    ...
    series: [
        {
            ...
            type: 'StackingStepArea', name: 'Organic', marker:{dataLabel : {visible : true}},
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y1',
            type: 'StackingStepArea', name: 'Fair-trade', marker:{dataLabel : {visible : true}},
        },
        {
            dataSource: stackedData, xName: 'x', yName: 'y2',
            type: 'StackingStepArea', name: 'Others', marker:{dataLabel : {visible : true}},
        }
    ],
