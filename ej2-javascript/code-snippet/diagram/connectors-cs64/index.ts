import {
    Diagram, Snapping, LineRouting, AvoidLineOverlapping, DiagramConstraints, NodeModel, ConnectorModel, Connector, PointPortModel, PortVisibility
...
let diagram: Diagram = new Diagram({
    ...
    getConnectorDefaults: (connector: ConnectorModel) => connector.cornerRadius = 5,
