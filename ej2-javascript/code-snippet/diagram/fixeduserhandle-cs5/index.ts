...
let diagram: Diagram = new Diagram({
  ...
  onFixedUserHandleMouseEnter: function (args: FixedUserHandleEventsArgs) {
    if (args.element) {
      args.element.fill = 'red';
      args.element.handleStrokeColor = 'pink';
    }
  },
  onFixedUserHandleMouseUp: function (args: FixedUserHandleEventsArgs) {
    //Customize
  },
  onFixedUserHandleMouseLeave: function (args: FixedUserHandleEventsArgs) {
    if (args.element) {
