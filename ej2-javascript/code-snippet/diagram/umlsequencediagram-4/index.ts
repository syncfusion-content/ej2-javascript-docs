import { Diagram, UmlSequenceDiagramModel, UmlSequenceMessageType, UmlSequenceFragmentType, SnapConstraints, UmlSequenceParticipantStereotype } from "@syncfusion/ej2-diagrams";
