...
let diagram: Diagram = new Diagram({
  ...
  onUserHandleMouseEnter: function (args: UserHandleEventsArgs) {
    if (args.element) {
      args.element.pathColor = 'red';
      args.element.backgroundColor = 'pink';
    }
  },
  onUserHandleMouseUp: function (args: UserHandleEventsArgs) {
    //Customize
  },
  onUserHandleMouseLeave: function (args: UserHandleEventsArgs) {
    if (args.element) {
