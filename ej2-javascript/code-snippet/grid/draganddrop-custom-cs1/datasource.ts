export let data: Object[] = [
    ...
    export let hierarchicalData: { [key: string]: Object }[] = [
        {
            nodeId: '04', nodeText: 'Pictures', icon: 'folder', expanded: true,
            nodeChild: [
                {
                    nodeId: '04-01', nodeText: 'Users',  expanded: true,
                    nodeChild: [
                        { nodeId: '04-01-01', nodeText: 'Smith' },
                        { nodeId: '04-01-02', nodeText: 'Admin' },
                        { nodeId: '04-01-02', nodeText: 'Public' },
                    ]
                },
                { nodeId: '04-02', nodeText: 'Windows',
                nodeChild: [
                    { nodeId: '04-02-01', nodeText: 'Boot' },
                    { nodeId: '04-02-02', nodeText: 'FileManager' },
                    { nodeId: '04-02-02', nodeText: 'System32' },
                 ]
                },
                { nodeId: '04-03', nodeText: 'Local Disk(D:)'  },
            ]
        }
    ];
