import { Grid, Formula, Edit } from '@syncfusion/ej2-grids';
import { productData } from './datasource.ts';

Grid.Inject(Formula, Edit);
...
let grid: Grid = new Grid({
    ...
    columns: [
        ...
        { field: 'GrossAmount', headerText: 'Gross Amount', width: 150, allowFormula: true, format: 'C2', allowEditing: false },
