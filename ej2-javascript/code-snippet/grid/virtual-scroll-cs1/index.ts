import { Grid, Selection, Sort, Filter, DomVirtualization } from '@syncfusion/ej2-grids';
import { DataManager, UrlAdaptor, Query } from '@syncfusion/ej2-data';

Grid.Inject(Selection, Sort, Filter, DomVirtualization);

// Template function for Employee ID with icon
(<{ employeeIDDetail?: Function }>window).employeeIDDetail = (e: any): any => {
...
(<{ employeeNameDetail?: Function }>window).employeeNameDetail = (e: any): any => {
    const container: HTMLElement = document.createElement('div');
...
(<{ designationDetail?: Function }>window).designationDetail = (e: any): any => {
    const container: HTMLElement = document.createElement('div');
...
(<{ locationDetail?: Function }>window).locationDetail = (e: any): any => {
