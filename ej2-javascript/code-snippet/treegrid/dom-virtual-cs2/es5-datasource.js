...
function domVirtualizationDataSource() {
    ...
    const warehouseNames = [ "Chicago Central Fulfillment Center",
 ...
 "Hartford Northeast Logistics"];
    ...
    const categories = [ "Consumer Electronics", "Home and Kitchen", "Office Supplies", "Travel Accessories",
 ...
 "Kitchen Appliances", "Sports Gear", "Storage and Organization"];
    ...
    const suppliers = [ "Northstar Imports", "Blue Ridge Manufacturing", "Evergreen Consumer Goods",
