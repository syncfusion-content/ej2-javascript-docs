...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Color picker package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Color picker CSS styles
...
@import "../../node_modules/@syncfusion/ej2-fluent2-theme/styles/color-picker/index.css";
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Color picker control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Color picker control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Color picker control, add the following JavaScript code to the `~/src/app/app.ts` file
