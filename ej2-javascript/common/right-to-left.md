---
layout: post
title: Right to Left (RTL) in ##Platform_Name## Controls | Syncfusion
description: Learn how to enable Right-to-Left (RTL) support in Syncfusion ##Platform_Name## controls for languages like Arabic and Hebrew.
...
# Right to Left (RTL) in Syncfusion® ##Platform_Name## Controls
