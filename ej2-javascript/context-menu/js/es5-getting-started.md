---
layout: post
title: Es5 getting started with ##Platform_Name## Context menu | Syncfusion
description: Learn how to render the Syncfusion ##Platform_Name## Context menu in ES5 JavaScript using the global script and ej2-navigations package.
...
# Es5 getting started in ##Platform_Name## Context menu
...
<!DOCTYPE html>
  <html xmlns="http://www.w3.org/1999/xhtml">
       <head>
          ...
          <!-- Essential JS 2 ContextMenu's dependent bootstrap5.3 theme -->
          ...
          <!-- Essential JS 2 ContextMenu's control bootstrap5.3 theme -->
...
>
> Styles: [`https://cdn.syncfusion.com/ej2/ej2-navigations/styles/bootstrap5.3.css`](http://cdn.syncfusion.com/ej2/ej2-navigations/styles/bootstrap5.3.css)
