...
description: Customize individual panel heights in mobile view of the Syncfusion ##Platform_Name## Dashboard Layout using the mobilePanelHeight property for responsive layouts.
...
{% include code-snippet/dashboard-layout/custom-panel-height-in-mobileview-cs1/index.ts %}
{% endhighlight %}
...
{% include code-snippet/dashboard-layout/custom-panel-height-in-mobileview-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/dashboard-layout/custom-panel-height-in-mobileview-cs1/index.html %}
{% endhighlight %}
