...
Construct your `Query` using chainable methods such as:

  * [from](https://ej2.syncfusion.com/documentation/api/data/query/#from) – Defines the data source.

  * [select](https://ej2.syncfusion.com/documentation/api/data/query/#select) – Specifies the fields to retrieve.

  * [where](https://ej2.syncfusion.com/documentation/api/data/query/#where) – Filters records based on conditions.

  * [sortBy](https://ej2.syncfusion.com/documentation/api/data/query/#sortby) – Sorts the data by one or more fields.

  * [take](https://ej2.syncfusion.com/documentation/api/data/query/#take) – Limits the number of records returned.
