---
layout: post
title: ##Platform_Name## DataManager - Querying | Syncfusion
description: Learn here all about Querying in Syncfusion ##Platform_Name## DataManager for filtering, sorting, paging, searching, grouping, aggregation, projection, expand, and hierarchical data.
...
The `Query` class in Syncfusion<sup style="font-size:70%">&reg;</sup> ##Platform_Name## DataManager is used to build structured queries that interact with a data source. The queries define operations such as filtering, sorting, paging, and grouping, making it easier to retrieve and manipulate data in a consistent way.
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/data/querying-cs30/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/data/querying-cs30/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "page.domainurl/code-snippet/data/querying-cs30" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/data/querying-cs30/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/data/querying-cs30/index.html %}
{% endhighlight %}
...
> To perform a search on specific fields, provide an array of field names as the second argument to the [search](../api/data/query#search) method.
