...
# Es5 getting started in ##Platform_Name## Datepicker control
...
**Step 5:** Now, add the `input` element and initiate the `Essential JS 2 DatePicker` component in the `index.html` by using following code
...
{% include code-snippet/datepicker/getting-started-cs10/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/datepicker/getting-started-cs10/index.html %}
{% endhighlight %}
{% endtabs %}
