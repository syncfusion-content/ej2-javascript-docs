---
layout: post
title: Accessibility in ##Platform_Name## DateRangePicker | Syncfusion
description: Discover accessibility support in ##Platform_Name## DateRangePicker, including screen reader, RTL, color contrast, and keyboard navigation compliance.
...
{% include code-snippet/daterangepicker/getting-started-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/daterangepicker/getting-started-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/daterangepicker/getting-started-cs1/index.html %}
{% endhighlight %}
