...
description: Learn here all about Es5 getting started with ##Platform_Name## Datetimepicker control of Syncfusion Essential JS 2 and more details.
...
# Es5 getting started with ##Platform_Name## Datetimepicker control
