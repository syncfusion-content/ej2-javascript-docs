...
Refer to the `RedisService` file in the `Services` folder of the [##Platform_Name## Diagram Collaborative Editing GitHub sample](), and add the `RedisService` to the `Program.cs` file.
