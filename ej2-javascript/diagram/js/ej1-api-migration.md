...
description: Migrate the Syncfusion® ##Platform_Name## Diagram from Essential® JS 1 to Essential® JS 2 with a side-by-side API mapping for properties, methods, and events.
