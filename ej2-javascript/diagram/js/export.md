...
description: Export the Syncfusion® ##Platform_Name## Diagram as image or SVG files using the exportDiagram method with options for region, mode, and file name.
