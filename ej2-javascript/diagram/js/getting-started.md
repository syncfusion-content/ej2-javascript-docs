...
Essential<sup style="font-size:70%">&reg;</sup> JS 2 (global script) is an ES5-compatible JavaScript library that can be used directly in modern web browsers without additional build tools.
...
<head>
     ...
     <link href="https://cdn.syncfusion.com/ej2/ej2-diagrams/styles/Tailwind3.css" rel="stylesheet" type="text/css" />
