---
layout: post
title: Annotation Interaction in ##Platform_Name## Diagram | Syncfusion®
description: Enable select, drag, rotate, and resize interactions on ##Platform_Name## Diagram annotations via the constraints property.
...
# Annotation Interaction in ##Platform_Name## Diagram
...
* The TypeScript Diagram control now supports defining the [`dragLimit`](../../api/diagram/annotationModel#draglimit) to the label while dragging from the connector and also update the position to the nearest segment offset.
