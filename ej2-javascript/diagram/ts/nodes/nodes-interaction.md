...
description: Select, drag, resize, and rotate ##Platform_Name## Diagram nodes interactively or programmatically using public APIs.
...
The TypeScript Diagram provides support to flip the node. [`flip`](../../api/diagram/node#flip) is performed to give the mirrored image of the original element.
