---
layout: post
title: Import and Export Visio files in ##Platform_Name## Diagram | Syncfusion®
...
# Import and Export Visio files in ##Platform_Name## Diagram
...
A Visio file can be selected from the local file system or retrieved from a server or cloud storage. Once the **.vsdx** file is available, it is passed to the TypeScript Diagram control as a **File** object using the [`importFromVisio`](../api/diagram/index-default#importfromvisio) method.
...
{% include code-snippet/diagram/visioImport-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram/visioImport-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "page.domainurl/code-snippet/diagram/visioImport-cs1" %}
...
The TypeScript Diagram control supports exporting diagrams to Microsoft Visio format using the [`exportToVisio`](../api/diagram/index-default#exporttovisio) method. This method generates a **.vsdx** file and automatically downloads it through the browser.
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/diagram/visioExport-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram/visioExport-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "page.domainurl/code-snippet/diagram/visioExport-cs1" %}
