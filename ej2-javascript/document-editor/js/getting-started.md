...
**Example:**
> Script: [`https://cdn.syncfusion.com/ej2/ej2-documenteditor/dist/global/ej2-documenteditor.min.js`](https://cdn.syncfusion.com/ej2/ej2-documenteditor/dist/global/ej2-documenteditor.min.js)
>
> Styles: [`https://cdn.syncfusion.com/ej2/ej2-documenteditor/styles/material.css`](https://cdn.syncfusion.com/ej2/ej2-documenteditor/styles/material.css)
...
{% include code-snippet/document-editor/es5-getting-started-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/document-editor/es5-getting-started-cs2/index.html %}
{% endhighlight %}
{% endtabs %}
