...
**Step 5:** Now, add the `DropDownButton` element and initiate the `Syncfusion JavaScript DropDownButton` control in the `index.html` by using following code
...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Syncfusion JavaScript DropDownButton** control.
...
`DropDownButton` element and initiate the `Syncfusion JavaScript DropDownButton` control in the index.html by using following code.
...
**Step 4:** Now, run the `index.html` in web browser, it will render the `Syncfusion JavaScript DropDownButton` control.
