---
layout: post
title: Style in ##Platform_Name## Dropdown List | Syncfusion
description: Customize the appearance of Syncfusion ##Platform_Name## Dropdown List using the documented CSS structure for the wrapper, popup, list, and input.
...
# Style in ##Platform_Name## Dropdown List
...
You can add a mandatory `asterisk(*)` to the placeholder and the float label using the `.e-input-group.e-control-wrapper.e-float-input .e-float-text::after` class.

{% if page.publishingplatform == "typescript" %}

 {% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/dropdownlist/asterisk-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/dropdownlist/asterisk-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/dropdownlist/asterisk-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/dropdownlist/asterisk-cs1/index.html %}
{% endhighlight %}
