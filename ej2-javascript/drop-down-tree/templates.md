...
The currently selected value that is displayed by default on the DropDownTree input element can be customized using the [valueTemplate](https://ej2.syncfusion.com/documentation/api/drop-down-tree/#valuetemplate) property.
