...
description: Learn about how to Pass custom value to server in the Syncfusion ##Platform_Name## File Manager component of Syncfusion Essential JS 2 and more.
