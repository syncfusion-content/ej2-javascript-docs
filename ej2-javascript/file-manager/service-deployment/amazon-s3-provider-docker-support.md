...
# Amazon S3 Provider Docker Support in ##Platform_Name## File Manager
...
Set the [`url`](../api/file-manager/ajaxSettingsModel#url), [`uploadUrl`](../api/file-manager/ajaxSettingsModel#uploadurl), [`downloadUrl`](../api/file-manager/ajaxSettingsModel#downloadurl), and [`getImageUrl`](../api/file-manager/ajaxSettingsModel#getimageurl) properties in the client-side File Manager control:
...
The following example configures the [`ajaxSettings`](../api/file-manager#ajaxsettings) properties.
...
let hostUrl: string = 'http://localhost:5000/';
...
{% if page.publishingplatform == "typescript" %}
For more information on how to get started with the File Manager control, refer to this [Getting Started](../ts/getting-started) page.
{% elsif page.publishingplatform == "javascript" %}
For more information on how to get started with the File Manager control, refer to this [Getting Started](../js/es5-getting-started) page.
{% endif %}
...
Please refer to these getting started pages to create a File Manager in [Angular](https://ej2.syncfusion.com/angular/documentation/file-manager/getting-started), [React](https://ej2.syncfusion.com/react/documentation/file-manager/getting-started), [Vue](https://ej2.syncfusion.com/vue/documentation/file-manager/getting-started), [ASP.NET Core](https://ej2.syncfusion.com/aspnetcore/documentation/file-manager/getting-started), [ASP.NET MVC](https://ej2.syncfusion.com/aspnetmvc/documentation/file-manager/getting-started), and [Blazor](https://blazor.syncfusion.com/documentation/file-manager/getting-started-with-web-app).
