...
formBuilder.setProperty(FormWidgetType.Textarea, {
    "key": "enableRtl",
    "label": "Enable RTL",
    "type": "boolean",
    "default": false
...
formBuilder.setProperty('textarea', {
    "key": "enableRtl",
    "label": "Enable RTL",
    "type": "boolean",
    "default": false
...
formBuilder.getProperty(FormWidgetType.Textarea, "label")!.visible = false;
formBuilder.refresh();
```
...
formBuilder.getProperty('textarea', "label").visible = false;
formBuilder.refresh();
```
