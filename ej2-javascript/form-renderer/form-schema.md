---
layout: post
title: Form Schema in ##Platform_Name## Form Renderer control | Syncfusion
description: Learn here all about the JSON schema structure that drives the Syncfusion ##Platform_Name## Form Renderer control of Syncfusion Essential JS 2 and more.
...
```ts
let formRenderer: FormRenderer = new FormRenderer({ schema: formSchema });
```

{% elsif page.publishingplatform == "javascript" %}

```js
var formRenderer = new ej.formrenderer.FormRenderer({ schema: formSchema });
```
