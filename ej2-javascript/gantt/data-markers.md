---
layout: post
title: Data markers in ##Platform_Name## Gantt Chart Control | Syncfusion
description: Learn here all about Data markers in Syncfusion ##Platform_Name## Gantt Chart control of Syncfusion Essential JS 2 and more.
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt/data-markers-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt/data-markers-cs3/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt/data-markers-cs3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt/data-markers-cs3/index.html %}
{% endhighlight %}
