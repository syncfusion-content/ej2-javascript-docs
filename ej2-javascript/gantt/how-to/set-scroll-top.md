---
layout: post
title: Set Scroll Position in ##Platform_Name## Gantt | Syncfusion
description: how to programmatically set the vertical scroll position in the Syncfusion ##Platform_Name## Gantt Chart for efficient navigation in large project datasets.
