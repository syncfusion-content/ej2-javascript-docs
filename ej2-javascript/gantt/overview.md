...
* [**Taskbars**](./scheduling-tasks): Supports unscheduled tasks, and it can be customized. Baselines can also be displayed for the tasks.
...
* [**Data markers or indicators**](./style-and-appearance): Displays indicators and flags along with taskbars and task labels.
