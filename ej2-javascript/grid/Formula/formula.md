---
layout: post
title: ##Platform_Name## Grid Formula Cells | Syncfusion
description: Learn how to use spreadsheet-style formulas in the ##Platform_Name## Data Grid with built-in functions, custom formulas, and automatic recalculation.
...
# Formula Cells in ##Platform_Name## Data Grid

Formula cells in the Syncfusion ##Platform_Name## Data Grid enable spreadsheet-like calculations directly within grid cells. Configure formulas to automatically compute values based on data from other cells and update results as underlying data changes.
...
{% include code-snippet/grid/formula-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/formula-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid/formula-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/formula-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/grid/formula-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/formula-cs3/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid/formula-cs3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/formula-cs3/index.html %}
{% endhighlight %}
