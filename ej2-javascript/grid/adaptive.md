...
description: Learn how to customize adaptive UI in ##Platform_Name## Data Grid with responsive dialogs, vertical row rendering, and optimized mobile layouts.
...
# Adaptive UI in ##Platform_Name## Data Grid
