...
When reordering columns in the ##Platform_Name## Grid control, you may want to take some specific action in response to the drag and drop events. To handle these events, you can define event handlers for the following events:
