...
description: Learn how to connect ##Platform_Name## Data Grid to Microsoft SQL Server using ASP.NET Core Web API, execute SQL queries, and manage data efficiently.
...
# Microsoft SQL Server Integration in ##Platform_Name## Data Grid
...
## Binding data from Microsoft SQL Server via an API service.
...
Let’s see how to perform CRUD operation using Microsoft SQL Server data with Syncfusion ##Platform_Name## Grid.
