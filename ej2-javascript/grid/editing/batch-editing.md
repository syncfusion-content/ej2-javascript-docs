...
# Batch Editing in ##Platform_Name## Data Grid
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/grid/undo-redo-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/undo-redo-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid/undo-redo-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/undo-redo-cs1/index.html %}
{% endhighlight %}
