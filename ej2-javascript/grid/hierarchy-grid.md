...
The Grid control provides the `detailExpand` and `detailCollapse` events, which are triggered when a detail row is about to expand or collapse. These events fire before the detail row actually expands or collapses, allowing you to control whether the action should proceed.
...
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/detail-row-events/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid/detail-row-events/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/detail-row-events/index.html %}
{% endhighlight %}
