---
layout: post
title: ##Platform_Name## Grid Laravel Integration | Syncfusion
description: Learn how to connect Laravel data to ##Platform_Name## Data Grid using REST APIs for CRUD operations, filtering, sorting, paging, and data management.
...
# Connecting PHP Laravel Data to ##Platform_Name## Data Grid
