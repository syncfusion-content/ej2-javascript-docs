---
layout: post
title: ##Platform_Name## Data Grid Overview and Features | Syncfusion
description: Learn how to use ##Platform_Name## Data Grid for data management, CRUD operations, sorting, filtering, grouping, paging, and virtualization.
...
- **API Details?** See [Data Grid API reference](https://ej2.syncfusion.com/documentation/api/grid/index-default)
