...
You can customize the appearance of aggregate elements in the ##Platform_Name## Grid control using CSS. Below are examples of how to customize the aggregate root element and the aggregate cell elements.
