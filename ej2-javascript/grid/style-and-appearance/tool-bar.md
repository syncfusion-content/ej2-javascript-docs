...
You can customize the appearance of the toolbar in the ##Platform_Name## Grid control using CSS. Here are examples of how to customize the toolbar root element and toolbar button element.
