---
layout: post
title: ##Platform_Name## Grid Toolbar | Syncfusion
description: Learn how to use the toolbar in ##Platform_Name## Data Grid with built-in actions, custom toolbar items, data export, search, and editing operations.
...
Enabling or disabling toolbar items dynamically in ##Platform_Name## Grid is to provide control over the availability of specific functionality based on application logic. This feature allows you to customize the toolbar based on various conditions or individuals interactions. 
...
By adding the toolbar at the bottom of the ##Platform_Name## Grid, important actions and functionality remain consistently visible and easily accessible, providing easy access to actions and operations without the need for scrolling.
...
Customizing toolbar buttons in ##Platform_Name## Grid using CSS involves modifying the appearance of built-in toolbar buttons by applying CSS styles. This provides a flexible and customizable way to enhance the visual presentation of the toolbar and create a cohesive interface.
