...
{% include code-snippet/grid/grid-cs173/ts/index.html %}
{% endhighlight %}
{% endtabs %}
...
The sorting feature enables you to order the records. It can be enabled by setting the  [`allowSorting`](../api/grid/#allowsorting) property as true. Inject the [`Sort`](../api/grid/sort/) module as follows. If [`Sort`](../api/grid/sort/) module is not injected, you cannot sort when a header is clicked. Sorting feature can be customized using the  [`sortSettings`](../api/grid/sortSettings/) property.
...
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/grid-cs174/ts/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/grid-cs175/ts/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/grid-cs176/ts/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid/grid-cs177/ts/index.html %}
{% endhighlight %}
{% endtabs %}
