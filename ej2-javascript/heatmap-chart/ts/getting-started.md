...
* **`Cannot find module '@syncfusion/ej2-heatmap'`.** Re-run `npm install` from the project root. For a custom project, install the package with `npm install @syncfusion/ej2-heatmap --save`.
