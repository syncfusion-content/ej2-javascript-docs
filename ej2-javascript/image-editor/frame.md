...
The [`frameChanging`](https://ej2.syncfusion.com/documentation/api/image-editor/index-default#framechange) event is triggered when applying frame on the image. This event provides information encapsulated within an object, which includes details about the frame applied in an image. This information encompasses:
