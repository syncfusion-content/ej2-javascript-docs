---
layout: post
title: LLM Model via ollama in ##Platform_Name## Inline AI Assist control | Syncfusion
...
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/index.js %}
{% endhighlight %}
