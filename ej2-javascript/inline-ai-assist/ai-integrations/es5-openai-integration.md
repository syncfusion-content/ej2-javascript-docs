---
layout: post
title: Azure OpenAI Integration in ##Platform_Name## Inline AI Assist control | Syncfusion
...
{% include code-snippet/inline-ai-assist/ai-integrations/open-ai/index.js %}
{% endhighlight %}
