...
# Integrate Inline AI Assist with Lite LLM
...
* **Syncfusion Inline AI Assist**: Install the package [@syncfusion/ej2-interactive-chat](https://www.npmjs.com/package/@syncfusion/ej2-interactive-chat).
...
To integrate **LiteLLM** with the **Syncfusion Inline AI Assist** control, update the `index.js` file in your JavaScript application. The control will send user prompts to the LiteLLM proxy, which forwards them to the configured LLM provider (e.g., **OpenAI** or **Azure OpenAI**) and returns natural language responses.
...
* The response is parsed as **Markdown** using the `marked` library and displayed in the Inline AI Assist control.

{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/inline-ai-assist/ai-integrations/lite-llm/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/inline-ai-assist/ai-integrations/lite-llm/js/index.html %}
{% endhighlight %}
...
Open your app to interact with the Inline AI Assist control integrated with LiteLLM.
