---
layout: post
title: Speech-to-Text with ##Platform_Name## Inline AI Assist | Syncfusion
...
1. The Syncfusion Inline AI Assist control is properly set up in your TypeScript application.
...
2. The Inline AI Assist control is integrated with [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-foundry/models/openai).
    - [Integration of Azure OpenAI With TypeScript Inline AI Assist control](../ai-integrations/openai-integration)
...
{% include code-snippet/inline-ai-assist/speech/stt/index.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/inline-ai-assist/speech/speech-configuration/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/inline-ai-assist/speech/tooltip-settings/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/inline-ai-assist/speech/speech-events/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
