---
layout: post
title: Azure OpenAI in ##Platform_Name## Inline AI Assist | Syncfusion®
description: Wire the Syncfusion® ##Platform_Name## Inline AI Assist to Azure OpenAI using your endpoint, API key, deployment, and the marked library for Markdown.
...
# Azure OpenAI in ##Platform_Name## Inline AI Assist 
...
Modify the `index.js` file to integrate the Azure OpenAI with the Inline AI Assist control.
...
{% include code-snippet/inline-ai-assist/ai-integrations/open-ai/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/inline-ai-assist/ai-integrations/open-ai/index.html %}
{% endhighlight %}
{% endtabs %}
