...
6. Click **Download** (element 1 in the screenshot below) to get the Syncfusion<sup style="font-size:70%">&reg;</sup> Essential Studio<sup style="font-size:70%">&reg;</sup> JavaScript – EJ2 web installer.

    ![Start trial download - web installer](images/start-trial-download-installer.png)

7. Click **More Download Options** (element 2 in the above screenshot) to get the Essential Studio<sup style="font-size:70%">&reg;</sup> JavaScript installer for various platforms.
   ...
   - **Windows**
     ...
     - **Offline Installer:** Available in `.EXE` and `.ZIP` formats.
         ...
         ![Start trial download - offline installer](images/offline-installer1.png)
...
If you have already obtained Syncfusion<sup style="font-size:70%">&reg;</sup> components through [npm](https://www.npmjs.com/search?q=%40syncfusion%2Fej2-), initiate an evaluation as follows:
