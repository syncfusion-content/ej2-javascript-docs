---
layout: post
title: Upgrading Syncfusion in ##Platform_Name## | Syncfusion
description: Learn how to upgrade Syncfusion ##Platform_Name## Essential Studio to the latest volume or service pack release.
...
The most recent version of Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript – EJ2 can be downloaded and installed by clicking the **Latest Version: {Version}** link at the top of the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript – EJ2 Control Panel.

![Syncfusion Control Panel with Latest Version link highlighted](images/upgrade3.png)
...
1. Open the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript – EJ2 Control Panel (from the Start menu or the desktop shortcut created during installation).
...
N> License key registration is not required for JavaScript if you are using scripts (`.js`) and CSS files. If you are using the Syncfusion npm packages, you must register the license key in your application as described in the [licensing documentation](https://ej2.syncfusion.com/documentation/licensing).
