---
layout: post
title: Telemetry in JavaScript Control | Syncfusion
description: Learn here all about Telemetry in Syncfusion JavaScript controls, including telemetry collection, usage tracking, configuration, and troubleshooting.
...
# Telemetry in Syncfusion® JavaScript controls

Syncfusion<sup style="font-size:70%">&reg;</sup> Telemetry collects anonymous usage information to help improve product quality, usability, and feature planning for Essential<sup style="font-size:70%">&reg;</sup> JS 2 (EJ2) controls.
...
Telemetry helps Syncfusion understand how EJ2 controls are used during development. This information is used to:

* Understand feature adoption and usage trends.
* Identify commonly used controls and packages.
...
<table>
	...
	<tr>
		<td>control name</td>
		<td>The Syncfusion EJ2 control being used.</td>
	</tr>
	<tr>
		<td>Feature Name</td>
	...
	<tr>
		<td>SDK name</td>
		<td>The Syncfusion EJ2 SDK associated with the control.</td>
	</tr>
	<tr>
		<td>SDK version</td>
	...
	<tr>
		<td>Event name</td>
		<td>Anonymous product usage events related to EJ2 control initialization or usage.</td>
	</tr>
</table>
...
Telemetry applies only to the usage of Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript controls during development.
...
If you do not want telemetry to be collected during development, disable it before initializing any Syncfusion EJ2 controls.
...
### Disable telemetry using script reference

If you are using EJ2 through script references, call `ej.base.Telemetry.disable()` before creating any control instance.

```html
<script src="https://cdn.syncfusion.com/ej2/34.2.2/dist/ej2.min.js"></script>
<script>
		ej.base.Telemetry.disable();
...
> Note: Call `ej.base.Telemetry.disable();` before creating or using any Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript control.
...
No. Telemetry collects only limited anonymous usage information related to EJ2 controls in development environments.

### When should `ej.base.Telemetry.disable()` be called?

Call `ej.base.Telemetry.disable()` at application startup, before creating any Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript control instance.
...
> **Note:** These messages are generated by the browser when a network request fails and do not impact Syncfusion control functionality.

**Solution**

To prevent this issue, disable telemetry at application startup by calling `ej.base.Telemetry.disable()` before creating any Syncfusion EJ2 controls. This stops telemetry data collection entirely during development.
