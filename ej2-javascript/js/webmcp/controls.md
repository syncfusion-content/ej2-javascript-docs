---
layout: post
title: WebMCP Supported JavaScript (ES5) Controls | Syncfusion
description: Learn about all Syncfusion JavaScript (ES5) controls with native WebMCP support, their available tools, use cases, and live demo samples.
control: WebMCP
...
# WebMCP Supported Syncfusion® JavaScript (ES5) Controls

WebMCP-enabled Syncfusion® JavaScript (ES5) controls expose control-specific tools that allow AI agents to interact with UI controls through natural language. These tools provide direct access to control APIs for reading data, performing actions, and automating workflows.
 
This page lists the supported WebMCP tools available in each Syncfusion® JavaScript (ES5) control.

## DataGrid

The Syncfusion® DataGrid control exposes **27 tools**, giving AI agents full programmatic control over grid data manipulation, selection, filtering, sorting, editing, and layout management.
...
The Syncfusion® Diagram control exposes **19 tools**, giving AI agents full programmatic control over diagram creation, manipulation, and management.
...
The Syncfusion® File Manager control exposes **7 tools** that enable AI agents to browse files, manage file operations, control the user interface, perform navigation, and automate common file management workflows.
...
The Syncfusion® Gantt control exposes 38 tools, giving AI agents full programmatic control over tasks, scheduling, hierarchy, view/layout, undo/redo history, and exports.
...
| undo | Rolls back the most recent change made through the control. |
...
| outdentTask | Outdents a task to make it a sibling of its parent task. |
...
The Syncfusion® PDF Viewer control exposes **23 tools** that enable AI agents to navigate pages, search and extract text, inspect page metadata, manage form fields, inspect bookmarks, handle annotations, manage redactions, adjust viewing/zoom, print, download, and automate PDF document workflows.
...
The Syncfusion® Pivot Table control exposes **23 tools**, giving AI agents full programmatic control over pivot data manipulation, analysis, formatting, and visualization.
...
The Syncfusion® Scheduler control exposes 5 tools, giving AI agents full programmatic control over events, view switching, and date navigation.
...
The Syncfusion® Spreadsheet control exposes **28 tools** across six categories, giving AI agents full programmatic control over data, formatting, structure, and visualizations.
...
The effectiveness of WebMCP tools depends on the quality of the prompt provided to the AI assistant. Clear and specific instructions help the AI choose the appropriate tool and produce accurate results. Here are some example prompts for the Spreadsheet control:
