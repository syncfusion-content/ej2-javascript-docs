---
layout: post
title: Axes in ##Platform_Name## Linear Gauge | Syncfusion
description: Configure axes, ticks, labels, and orientation in the ##Platform_Name## Linear Gauge for clear numeric scale rendering.
...
# Axes in ##Platform_Name## Linear Gauge
