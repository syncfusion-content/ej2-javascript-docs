...
description: Print or export the ##Platform_Name## Linear Gauge as JPEG, PNG, SVG, or PDF images and documents using built-in print and export APIs.
...
# Print and Export in ##Platform_Name## Linear Gauge
