...
The [`zIndex`](../api/maps/annotationModel/zindex) property in the [`annotations`](../api/maps/annotationModel) controls the stack order of annotation elements. A higher z-index value places the annotation above other Mpas elements.
