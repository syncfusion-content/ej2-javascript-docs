---
layout: post
title: Getting Started with ##Platform_Name## MultiSelect Dropdown | Syncfusion
description: Set up the Syncfusion ##Platform_Name## MultiSelect Dropdown in a plain JavaScript (ES5) app, including dependencies and a local environment.
...
# Getting Started with ##Platform_Name## MultiSelect Dropdown
...
**Step 5:** Now, add the `input` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 MultiSelect** component in the `index.html` by using following code
...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 MultiSelect** component.
...
**Step 3:** Create a HTML page (index.html) in `myapp` location and add the CDN link references. Now, add the `input` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 MultiSelect** component in the index.html by using following code.
...
**Step 4:** Now, run the `index.html` in web browser, it will render the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 MultiSelect** component.
