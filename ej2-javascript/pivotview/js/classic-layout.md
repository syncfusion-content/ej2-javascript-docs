---
layout: post
title: Classic layout in ##Platform_Name## Pivot Table component | Syncfusion
...
To enable the classic layout, set the [layout](https://ej2.syncfusion.com/javascript/documentation/api/pivotview/gridSettings#layout) property in the [gridSettings](https://ej2.syncfusion.com/javascript/documentation/api/pivotview/gridSettings) of the Pivot Table to **Tabular**.
