---
layout: post
title: Overview of JavaScript Pivot Table | Syncfusion
description: Explore the JavaScript Pivot Table overview and feature matrix for data analysis, sources, layouts, performance, exporting, accessibility, and AI.
control: Pivot Table
...
# Overview of JavaScript Pivot Table

The Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Pivot Table provides interactive tools for summarizing, organizing, exploring, and presenting multidimensional data. Use the following feature overview to identify the available capabilities, understand where they apply, and open the corresponding user guide topic for configuration details and limitations.
...
| Show or hide subtotals and grand totals | Configurable | Relational and OLAP | [Show or hide totals](./summary-customization) |
...
| Touch interaction and mobile-device support | Built-in | Relational and OLAP | [Accessibility](./accessibility) and [touch support](https://www.syncfusion.com/javascript-ui-controls/js-pivot-table#touch-support) |
...
| High Contrast theme support | Configurable | Component UI | [Themes](https://ej2.syncfusion.com/javascript/documentation/appearance/theme) |
...
* [Live Pivot Table demos](https://ej2.syncfusion.com/javascript/demos/#/tailwind3/pivot-table/overview)
* [Pivot Table API reference](https://ej2.syncfusion.com/javascript/documentation/api/pivotview/index-default)
* [Release notes](https://ej2.syncfusion.com/javascript/documentation/release-notes)
