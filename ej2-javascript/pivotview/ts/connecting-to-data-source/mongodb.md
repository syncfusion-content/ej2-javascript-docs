---
layout: post
title: Mongodb in ##Platform_Name## Pivot Table Component | Syncfusion
description: Learn here all about Mongodb in Syncfusion ##Platform_Name## Pivot Table Component of Syncfusion Essential JS 2 and more.
...
# MongoDB in ##Platform_Name## Pivot Table Component
...
1. In the **app.ts** file, map the Web API URL (`https://localhost:44346/Pivot`) to the Pivot Table using the [url](https://ej2.syncfusion.com/documentation/api/pivotview/dataSourceSettings#url) property within the [dataSourceSettings](https://ej2.syncfusion.com/documentation/api/pivotview/dataSourceSettings).
...
1. Configure the Pivot Table report in the **app.ts** file to structure the data retrieved from the MongoDB database.
...
Explore a complete example of the Typescript Pivot Table integrated with an ASP.NET Core Web Application to fetch data from a MongoDB database in this [GitHub](https://github.com/SyncfusionExamples/how-to-bind-MongoDB-to-pivot-table) repository.