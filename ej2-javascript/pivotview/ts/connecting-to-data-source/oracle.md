...
1. Configure the Pivot Table report in the **app.ts** file to structure the data retrieved from the Oracle database.
...
Explore a complete example of the Typescript Pivot Table integrated with an ASP.NET Core Web Application to fetch data from an Oracle database in this [GitHub](https://github.com/SyncfusionExamples/how-to-bind-Oracle-database-to-pivot-table) repository.