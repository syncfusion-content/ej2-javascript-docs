---
layout: post
title: Snowflake in ##Platform_Name## Pivot Table Component | Syncfusion
description: Learn here all about Snowflake in Syncfusion ##Platform_Name## Pivot Table Component of Syncfusion Essential JS 2 and more.
...
![Installing the Snowflake.Data NuGet package](../images/snowflake-data-nuget-package-install.webp)
...
![JSON data from the Web API endpoint](../images/snowflake-code-web-app.webp)
...
1. Configure the Pivot Table report in the **app.ts** file to structure the data retrieved from the Snowflake database.
...
![Pivot Table bound with Snowflake database](../images/snowflake-data-binding.webp)

### Additional Resources
Explore a complete example of the Typescript Pivot Table integrated with an ASP.NET Core Web Application to fetch data from a Snowflake database in this [GitHub](https://github.com/SyncfusionExamples/how-to-bind-Snowflake-database-to-pivot-table) repository.