---
layout: post
title: Overview of TypeScript Pivot Table | Syncfusion
description: Explore the TypeScript Pivot Table overview and feature matrix for data analysis, sources, layouts, performance, exporting, accessibility, and AI.
control: Pivot Table
...
# Overview of TypeScript Pivot Table

The Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Pivot Table provides interactive tools for summarizing, organizing, exploring, and presenting multidimensional data. Use the following feature overview to identify the available capabilities, understand where they apply, and open the corresponding user guide topic for configuration details and limitations.
...
| High Contrast theme support | Configurable | Component UI | [Themes](https://ej2.syncfusion.com/documentation/appearance/theme) |
...
* [Live Pivot Table demos](https://ej2.syncfusion.com/demos/#/tailwind3/pivot-table/overview.html)
* [Pivot Table API reference](https://ej2.syncfusion.com/documentation/api/pivotview/index-default)
