...
description: Customize ##Platform_Name## Predefined dialogs by overriding OK and Cancel button text, icons, content, and the showCloseIcon behavior.
...
# Customization in ##Platform_Name## Predefined Dialogs
...
You can also manually close the Dialogs by creating an instance to the dialog and call the [hide](https://ej2.syncfusion.com/angular/documentation/api/dialog/index-default#hide) method.
