...
description: Learn how the ##Platform_Name## Progress Button meets WCAG 2.2, Section 508, and WAI-ARIA accessibility standards with full keyboard support.
...
# Accessibility in ##Platform_Name## Progress Button
