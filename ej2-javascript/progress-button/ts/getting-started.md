...
description: Learn how to get started with the ##Platform_Name## Progress Button in TypeScript, from package setup and CSS to first render.
...
This section explains how to create a simple ProgressButton control and configure its available functionalities in TypeScript, using the Essential<sup style="font-size:70%">&reg;</sup> JS 2 [quickstart](https://github.com/SyncfusionExamples/ej2-quickstart-webpack-) seed repository. This seed repository is pre-configured with the Essential<sup style="font-size:70%">&reg;</sup> JS 2 package.
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Progress Button package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Progress Button CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Progress Button control to the application

The Progress Button can be initialized through input tags.

Add the HTML input element which needs to be initialized as Progress Button in `index.html`.

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript UI controls. 

In this article, the ProgressButton control is used as an example. Add the following ProgressButton element to the `~/src/index.html` file.
