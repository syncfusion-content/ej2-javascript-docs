---
layout: post
title: Style and appearance in ##Platform_Name## Query builder control | Syncfusion
description: Learn here all about Style and appearance in Syncfusion ##Platform_Name## Query builder control of Syncfusion Essential JS 2 and more.
...
# Style and appearance in ##Platform_Name## Query builder control

To modify the QueryBuilder appearance, you need to override the default CSS of QueryBuilder component. Please find the list of CSS classes and its corresponding section in QueryBuilder component. Also, you have an option to create your own custom theme for the controls using our [`Theme Studio`](https://ej2.syncfusion.com/themestudio/?theme=bootstrap5).
