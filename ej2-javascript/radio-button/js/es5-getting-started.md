...
The list of dependencies required to use the Radio button component in your application is given below:
...
**Step 3:** Open Visual Studio Code and create **my-app/index.js** and **my-app/index.html** files to initialize the Essential<sup style="font-size:70%">&reg;</sup> JS 2 Radio button control.

## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> resources

The Essential<sup style="font-size:70%">&reg;</sup> JS 2 Radio button control can be initialized by using either of the following ways.
...
To use local scripts and styles for Syncfusion<sup style="font-size:70%">&reg;</sup> Radio button, you can follow these steps:
...
**Step 5:** Now, add the `RadioButton` element and initiate the **Syncfusion<sup style="font-size:70%">&reg;</sup> Javascript RadioButton** control in the `~/quickstart/index.html` by using following code
...
**Step 6:** Run the `index.html` in a web browser to render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript RadioButton** control.
...
**Step 3:** Create a HTML page (index.html) in `~/quickstart/index.html` location and add the CDN link references. Now, add the `RadioButton` element and initiate the **Syncfusion<sup style="font-size:70%">&reg;</sup> Javascript RadioButton** control in the index.html by using following code.
...
**Step 4:** Run the `index.html` in a web browser to render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript RadioButton** control.
