---
layout: post
title: Accessibility in ##Platform_Name## Range Selector | Syncfusion
description: Learn here all about Accessibility in Syncfusion ##Platform_Name## Range Selector of Syncfusion Essential JS 2 and more.
...
# Accessibility in ##Platform_Name## Range Selector
...
The accessibility compliance of the Range navigator control is shown in the following sample. Open the [sample](https://ej2.syncfusion.com/accessibility/range-navigator.html) in a new window to evaluate the accessibility of the Range navigator control with accessibility tools.
