...
**Populate Range Navigator with Data**: Create a [`series`](https://ej2.syncfusion.com/documentation/api/range-navigator/index-default#series) object for the Range Navigator. Map the field names `x` and `y` in the JSON data to the [`xName`](https://ej2.syncfusion.com/documentation/api/range-navigator/rangenavigatorseriesmodel#xname) and [`yName`](https://ej2.syncfusion.com/documentation/api/range-navigator/rangenavigatorseriesmodel#yname) properties of the series, then set the JSON data to the [`dataSource`](https://ej2.syncfusion.com/documentation/api/range-navigator/index-default#datasource) property. Since the JSON contains DateTime data, set the [`valueType`](https://ej2.syncfusion.com/documentation/api/range-navigator/index-default#valuetype) to `'DateTime'`. By default, the axis `valueType` is `'Double'`.
