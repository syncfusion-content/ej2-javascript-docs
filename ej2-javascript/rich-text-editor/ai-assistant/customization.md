...
1. **Custom Header Toolbar Item**
   ...
   * The **DropDownButton** control is dynamically initialized in the `beforePopupOpen` event when the AI Assistant popup opens.
...
{% include code-snippet/rich-text-editor/ai-assistant/custom-toolbar-items/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/custom-toolbar-items/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor/ai-assistant/custom-toolbar-items/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/custom-toolbar-items/index.html %}
{% endhighlight %}
...
{% include code-snippet/rich-text-editor/ai-assistant/popup-styling/index.css %}
{% endhighlight %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/rich-text-editor/ai-assistant/popup-styling/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/popup-styling/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/rich-text-editor/ai-assistant/popup-styling/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/popup-styling/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/rich-text-editor/ai-assistant/usecase/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/usecase/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/rich-text-editor/ai-assistant/usecase/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/ai-assistant/usecase/index.html %}
{% endhighlight %}
