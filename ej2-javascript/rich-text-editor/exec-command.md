---
layout: post
title: Execute command in ##Platform_Name## Rich text editor | Syncfusion
...
| numberFormatList | Creates an ordered list with customizable numbering styles. The available formats are listed [here](https://ej2.syncfusion.com/documentation/rich-text-editor/tools/text-formatting#available-numbering-styles).|`rteObj.executeCommand('numberFormatList', 'decimal');`|
| bulletFormatList | Creates an unordered list with customizable bullet styles. The available formats are listed[here](https://ej2.syncfusion.com/documentation/rich-text-editor/tools/text-formatting#available-bullet-styles). |`rteObj.executeCommand('bulletFormatList', 'disc');`|
