...
| [allowedStyleProps](https://ej2.syncfusion.com/documentation/api/rich-text-editor/pastecleanupsettingsmodel#allowedstyleprops) |  See the full list of allowed properties in the [documentation link here](https://ej2.syncfusion.com/angular/documentation/api/rich-text-editor/index-default#pastecleanupsettings) | string[] |
...
You can get the pasted text as HTML using the [afterPasteCleanup](https://ej2.syncfusion.com/documentation/api/rich-text-editor/index-default#afterpastecleanup) event.
