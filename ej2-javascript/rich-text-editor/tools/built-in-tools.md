---
layout: post
title: Built-in Tools in ##Platform_Name## Rich text editor control | Syncfusion
description: Learn here all about Built-in Tools in Syncfusion ##Platform_Name## Rich text editor control of Syncfusion Essential JS 2 and more.
...
# Built-in Tools in ##Platform_Name## Rich Text Editor control
...
{% include code-snippet/rich-text-editor/remove-buildin-tool-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/remove-buildin-tool-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor/remove-buildin-tool-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor/remove-buildin-tool-cs1/index.html %}
{% endhighlight %}
