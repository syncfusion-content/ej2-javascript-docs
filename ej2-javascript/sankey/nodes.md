---
layout: post
title: Nodes in ##Platform_Name## Sankey Diagram | Syncfusion
description: Learn here all about Nodes in Syncfusion ##Platform_Name## Sankey Diagram of Syncfusion Essential JS 2 and more.
...
# Nodes in ##Platform_Name## Sankey Diagram
...
{% include code-snippet/sankey/nodes/customization-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/customization-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/sankey/nodes/customization-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/customization-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/nodes/individual-color-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/individual-color-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/nodes/individual-color-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/individual-color-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/nodes/opacity-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/opacity-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/nodes/opacity-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/opacity-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/nodes/offset-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/offset-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/nodes/offset-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/nodes/offset-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/nodes/rendering-event-cs/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
