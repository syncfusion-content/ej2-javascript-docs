---
layout: post
title: Print and Export in ##Platform_Name## Sankey Diagram | Syncfusion
description: Learn here all about Print and Export in Syncfusion ##Platform_Name## Sankey Diagram of Syncfusion Essential JS 2 and more.
...
# Print and Export in ##Platform_Name## Sankey Diagram
...
{% include code-snippet/sankey/print-export/print-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/print-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/sankey/print-export/print-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/print-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/print-export/export-formats-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-formats-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/print-export/export-formats-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-formats-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/print-export/export-custom-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-custom-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/print-export/export-custom-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-custom-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/print-export/before-export-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/before-export-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/print-export/before-export-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/before-export-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/sankey/print-export/export-completed-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-completed-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/sankey/print-export/export-completed-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/sankey/print-export/export-completed-cs1/index.html %}
{% endhighlight %}
