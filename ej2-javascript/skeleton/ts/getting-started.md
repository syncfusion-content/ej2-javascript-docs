...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Skeleton package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Skeleton CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Skeleton control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Skeleton control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Skeleton control, add the following JavaScript code to the `~/src/app/app.ts` file
