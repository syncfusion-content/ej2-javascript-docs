...
description: Learn how to get started with the ##Platform_Name## Speed Dial in TypeScript, from package setup and CSS to first render.
...
This section explains how to create a simple Speed dial, and configure its available functionalities in TypeScript, using Essential<sup style="font-size:70%">&reg;</sup> JS 2 [quickstart](https://github.com/SyncfusionExamples/ej2-quickstart-webpack-) seed repository. This seed repository is pre-configured with the Essential<sup style="font-size:70%">&reg;</sup> JS 2 package.
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Speed dial package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Speed dial CSS styles
...
@import "../../node_modules/@syncfusion/ej2-fluent2-theme/styles/speed-dial/index.css";
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Speed dial control to the application

The Speed dial can be initialized through input tags.

Add the HTML input element which needs to be initialized as Speed dial in `index.html`.

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript UI controls. 

In this article, the Speed dial control is used as an example. Add the following Speed dial element to the `~/src/index.html` file.
