...
description: Get started with the ##Platform_Name## Spinner using ES5 script and style references, including local resources, CDN, and a createSpinner example.
