...
description: Get started with the ##Platform_Name## Spinner using the quickstart seed, install ej2-popups, and create a target-bound Spinner with show and hide.
...
@import "../../node_modules/@syncfusion/ej2-fluent2-theme/styles/spinner/index.css";
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Spinner control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript UI controls. 

In this article, the Spinner control is used as an example. Add the following Spinner element to the `~/src/index.html` file.
...
To render the Spinner control, add the following TypeScript code to the `~/src/app/app.ts` file
