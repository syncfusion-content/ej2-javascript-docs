...
description: Learn how to get started with the ##Platform_Name## Split Button in JavaScript (ES5) from package setup to first render.
...
**Step 5:** Now, add the `SplitButton` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 SplitButton** control in the `index.html` by using following code
...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript SplitButton** control.
...
`SplitButton` element and initiate the **Essential<sup style="font-size:70%">&reg;</sup> JS 2 SplitButton** control in the index.html by using following code.

{% tabs %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/split-button/es5-getting-started-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "page.domainurl/code-snippet/split-button/es5-getting-started-cs1" %}

**Step 4:** Now, run the `index.html` in web browser, it will render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript SplitButton** control.
