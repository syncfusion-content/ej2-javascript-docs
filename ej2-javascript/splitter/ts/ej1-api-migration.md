---
layout: post
title: Ej1 API Migration in ##Platform_Name## Splitter | Syncfusion
description: Migrate Splitter code from Essential JS 1 to Essential JS 2 by mapping properties, events, and methods between the two APIs with side-by-side examples.
...
# Ej1 API Migration in ##Platform_Name## Splitter
