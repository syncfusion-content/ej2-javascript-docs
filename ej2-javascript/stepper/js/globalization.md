...
RTL provides an option to switch the text direction and layout of the Stepper control from right to left by setting the [enableRtl](https://ej2.syncfusion.com/javascript/documentation/api/stepper#enablertl) property to `true`.
