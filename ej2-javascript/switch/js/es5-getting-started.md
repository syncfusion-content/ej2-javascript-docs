...
description: Learn how to get started with the ##Platform_Name## Toggle Switch Button in JavaScript (ES5) from package setup to first render.
...
This section explains the steps required to create a simple Essential<sup style="font-size:70%">&reg;</sup> JS 2 Switch  and demonstrate the basic usage of the Switch  control in a JavaScript application.
...
**Step 3:** Open Visual Studio Code and create **my-app/index.js** and **my-app/index.html** files to initialize the Essential<sup style="font-size:70%">&reg;</sup> JS 2 Switch  control.

## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> resources

The Essential<sup style="font-size:70%">&reg;</sup> JS 2 Switch  control can be initialized by using either of the following ways.
...
**Step 5:** Now, add the `Switch` element and initiate the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Switch** control in the `index.html` by using following code
...
**Step 6:** Now, run the `index.html` in web browser, it will render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Switch** control.
...
**Step 3:** Create a HTML page (index.html) in `~/quickstart/index.html` location and add the CDN link references. Now, add the `Switch` element and initiate the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Switch** control in the index.html by using following code.
...
**Step 4:** Now, run the `index.html` in web browser, it will render the **Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Switch** control.
