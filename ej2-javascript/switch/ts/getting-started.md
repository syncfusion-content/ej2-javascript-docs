...
description: Learn how to get started with the ##Platform_Name## Toggle Switch Button in TypeScript, from package setup and CSS to first render.
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Switch package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Switch CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Switch control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Switch control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Switch control, add the following JavaScript code to the `~/src/app/app.ts` file
