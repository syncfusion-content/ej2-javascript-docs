...
* Both - By default, this option allows users to swipe between tabs using both touch and mouse actions.
* Touch - This option allows users to swipe between tabs using touch gestures only.
* Mouse - This option allows users to swipe between tabs using mouse actions only.
* None - This option disables both touch and mouse swipe actions, preventing unintended tab switches.
