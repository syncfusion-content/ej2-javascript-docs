...
description: Integrate the ##Platform_Name## TextArea with HTML forms so that multiline input values are submitted naturally with the rest of the form data.
