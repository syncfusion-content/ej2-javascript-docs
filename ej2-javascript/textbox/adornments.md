...
description: Add custom elements before or after the ##Platform_Name## TextBox using prependTemplate and appendTemplate to include icons, text labels, or action buttons.
...
{% include code-snippet/textbox/adornments-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/textbox/adornments-cs1/index.html %}
{% endhighlight %}
{% highlight css tabtitle="styles.css" %}
{% include code-snippet/textbox/adornments-cs1/index.css %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/textbox/adornments-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/textbox/adornments-cs1/index.html %}
{% endhighlight %}
