...
description: Learn how to get started with the Syncfusion ##Platform_Name## Toolbar control and configure it for TypeScript apps quickly.
...
This section explains how to create a simple **Toolbar** using TypeScript, and how to configure ToolBar items like button, separator, and input components using Essential<sup style="font-size:70%">&reg;</sup> JS 2 [quickstart](https://github.com/SyncfusionExamples/ej2-quickstart-webpack-) seed repository.
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Toolbar package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Toolbar CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Toolbar control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Toolbar control is used as an example. Add the following element to the `~/src/index.html` file.
...
To render the Toolbar control, add the following JavaScript code to the `~/src/app/app.ts` file
