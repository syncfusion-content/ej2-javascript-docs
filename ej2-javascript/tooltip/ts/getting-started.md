...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Tooltip package
...
## Import Syncfusion<sup style="font-size:70%">&reg;</sup> Tooltip CSS styles
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Tooltip control to the application

Open the application in Visual Studio Code and add the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript UI controls. 

In this article, the Tooltip control is used as an example. Add the following Tooltip element to the `~/src/index.html` file.
...
To render the Tooltip control, add the following JavaScript code to the `~/src/app/app.ts` file
