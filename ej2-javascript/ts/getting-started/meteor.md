...
> For detailed installation instructions, see the official [Meteor installation guide](https://docs.meteor.com/about/install.html).
...
Open the localhost URL in the web browser.
