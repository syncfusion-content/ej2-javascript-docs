---
layout: post
title: Release Notes - Syncfusion TypeScript MCP Server | Syncfusion
description: Explore the release notes for Syncfusion TypeScript MCP Server, featuring Agentic UI Builder, 145+ controls, theme integration, and AI-powered TypeScript development tools.
...
# Syncfusion TypeScript MCP Server Release Notes

This document provides information about the changes and new features included in each version of the [@syncfusion/typescript-assistant](https://www.npmjs.com/package/@syncfusion/typescript-assistant) MCP server package.
...
- Initial release of AI Coding Assistant for Syncfusion TypeScript controls.
