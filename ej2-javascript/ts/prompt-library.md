...
* Run the prompt using either of the following AI tools:
  ...
  * **Skills**: Skills can also run automatically based on the query, or can be called explicitly using the `/syncfusion-javascript-grid` skill.
...
How do I integrate a form and validate input using the RichTextEditor?
{% endpromptcard %}
