---
layout: post
title: Telemetry in TypeScript Control | Syncfusion
description: Learn here all about Telemetry in Syncfusion TypeScript controls, including telemetry collection, usage tracking, configuration, and troubleshooting.
...
# Telemetry in Syncfusion® TypeScript controls
...
Telemetry applies only to the usage of Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript controls during development.
...
If you are using npm packages and ES module imports, call `Telemetry` from `@syncfusion/ej2-base` before creating any EJ2 controls.
...
> Note: Call `Telemetry.disable();` before creating or using any Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript control.
...
Call `Telemetry.disable()` at application startup, before creating any Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript control instance.
...
To prevent this issue, disable telemetry at application startup by calling `Telemetry.disable()` before creating any Syncfusion EJ2 controls. This stops telemetry data collection entirely during development.
