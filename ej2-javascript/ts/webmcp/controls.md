---
layout: post
title: WebMCP Supported JavaScript Controls | Syncfusion
description: Learn about all Syncfusion JavaScript controls with native WebMCP support, their available tools, use cases, and live demo samples.
control: WebMCP
...
# WebMCP Supported Syncfusion® JavaScript Controls

WebMCP-enabled Syncfusion® JavaScript controls expose control-specific tools that allow AI agents to interact with UI controls through natural language. These tools provide direct access to control APIs for reading data, performing actions, and automating workflows.
 
This page lists the supported WebMCP tools available in each Syncfusion® JavaScript control.
