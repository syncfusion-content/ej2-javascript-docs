...
description: Learn how to get started with the Syncfusion ##Platform_Name## File Upload control using the ES5 global-script syntax in any modern web browser.
