---
title: "Insert text, paragraph and rich-text content in JavaScript DocumentEditor | Syncfusion " 
component: "DocumentEditor" 
description: "Learn how to insert text, paragraph and rich-text content in JavaScript Document Editor component." 
---

# How to insert text, paragraph and rich-text content in JavaScript Document Editor component
...
To insert the HTML content, you have to convert the HTML content to SFDT Format using [`web service`](../../document-editor/web-services). Then use [`paste`](../../api/document-editor/editor/#paste) API to insert the sfdt at current cursor position.
