...
Document editor have [`created`](../../api/document-editor/#created) event which gets triggered once Document editor control created. So, if you want to open the document by default, you can use `open` and `created` API.

The following example illustrates how to open the default SFDT content once Document editor control gets created.

{% tab template="document-editor/open-default-document",es5Template="base", sourceFiles="index.ts,index.html" %}
...
Document editor Container have [`created`](../../api/document-editor-container/#created) event which gets triggered once Document editor container control created. So, if you want to open the document by default, you can use `open` and `created` API.

{% tab template="document-editor/open-default-document",es5Template="open-default-window", sourceFiles="index.ts,index.html" %}
