...
{% tab template="gantt/predecessor", es5Template="enableDependency"%}
...
{% tab template="gantt/predecessor", es5Template="predecessorWithOffset"%}
...
{% tab template="gantt/predecessor", es5Template="validatePredecessorLinks"%}
...
{% tab template="gantt/predecessor", es5Template="validateWithDialog"%}
