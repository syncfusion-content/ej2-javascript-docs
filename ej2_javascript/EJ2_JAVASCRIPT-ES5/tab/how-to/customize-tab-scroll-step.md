...
component: "Tab"
description: "This example demonstrates how to customize the scroll step of Essential JS 2 Tab."
---
...
{% tab template="tab/tab-scrollstep", es5Template="es5_tab-scrollstep", sourceFiles="index.ts,index.html"%}
