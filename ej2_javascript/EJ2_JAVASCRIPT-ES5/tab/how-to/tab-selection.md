...
{% tab template="tab/tab-selection", es5Template="es5_tab-selection", sourceFiles="index.ts,index.html"%}

```typescript
import { Tab, SelectingEventArgs, SelectEventArgs } from '@syncfusion/ej2-navigations';
