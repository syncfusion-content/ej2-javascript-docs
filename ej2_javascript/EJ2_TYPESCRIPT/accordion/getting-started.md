...
component: "Accordion"
description: "This section explains how to create Accordion component in an Typescript application with its basic features."
---
...
{% tab template="accordion/accordion", es5Template="es5_accordion", isDefaultActive=true, sourceFiles="index.ts,index.html"  %}
...
{% tab template="accordion/accordion-template", es5Template="es5_accordion_template", sourceFiles="index.ts,index.html" %}
