...
component: "Dialog"
description: "This section explains how to add minimize and maximize buttons to the Dialog header in Dialog component"
---
...
{% tab template="dialog/dialog-minimize-maximize",sourceFiles="app.ts,index.html", es5Template="dialog-min-max-template" %}
