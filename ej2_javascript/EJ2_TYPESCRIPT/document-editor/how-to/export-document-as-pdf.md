...
>Note: You can install the pdf export packages from this [`link`](https://www.npmjs.com/package/@syncfusion/ej2-pdf-export) and There is one limitation we can’t search the text because we are exporting the pdf as image.
