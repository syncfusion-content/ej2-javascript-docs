...
description: "This section helps to learn how to create the dropdownbutton in HML5 JavaScript application with its basic features in step-by-step procedure."
---
...
To get started with the DropDownButton component, you can clone the [`Essential JS 2 quickstart`](https://github.com/syncfusion/ej2-quickstart) project
...
{% tab template= "drop-down-button/getting-started", sourceFiles="app.ts,index.html,styles.css",
