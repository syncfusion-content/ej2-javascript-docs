...
functionalities in TypeScript using the Essential JS 2 [quickstart](https://github.com/syncfusion/ej2-quickstart).
...
>The [project](https://github.com/syncfusion/ej2-quickstart) is pre-configured with the common
