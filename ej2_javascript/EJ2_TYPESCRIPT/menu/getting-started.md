...
component: "Menu"
description: "This section helps to learn how to create the menu in HTML5 JavaScript application with its basic features (rendering with data items and divider in menu items) in step-by-step procedure."
---
