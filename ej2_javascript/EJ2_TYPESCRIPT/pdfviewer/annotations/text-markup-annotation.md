...
{% tab template="pdfviewer/text-markup-annotation/highlight-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/highlight-normal-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/underline-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/underline-normal-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/strikethrough-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/strikethrough-normal-mode", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
...
{% tab template="pdfviewer/text-markup-annotation/undo-redo", es5Template="es5-text-markup-annotation" , sourceFiles="index.ts,index.html" %}
