...
description: "This section helps to learn how to create the query builder in HML5 JavaScript application with its basic features in step-by-step procedure."
---
...
To get started with the Query Builder component, you can clone the
...
* Refer to the [`QueryBuilder component dependencies`](./getting-started#dependencies) in `system.config.js` configuration file.
