...
description: "This section explains how to create a simple Syncfusion JavaScript Rich Text Editor control and configure its functionalities in typescript application."
---
...
[`GitHub`](https://github.com/syncfusion/ej2-quickstart.git), and install the necessary npm packages using the following command line scripts.
...
> To know about individual component CSS, refer to the
...
Now import the Rich Text Editor component to your `app.ts` and initialize it to the element `#defaultRTE` as
shown below.
...
{% tab template="rich-text-editor/getting-started", es5Template="basic" %}
