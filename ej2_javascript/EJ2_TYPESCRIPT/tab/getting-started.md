...
component: "Tab"
description: "This section explains how to create a Tab component in an Typescript application with its basic features."
---

# Getting Started

This section briefly explains about how to create a simple Tab using TypeScript and configure the Tab header content using Essential JS 2 [quickstart](https://github.com/syncfusion/ej2-quickstart.git) seed repository.
...
{% tab template="tab/tab", es5Template="es5_tab", isDefaultActive=true, sourceFiles="index.ts,index.html"%}
...
{% tab template="tab/tab-template", es5Template="es5_tab_template", sourceFiles="index.ts,index.html,index.css"%}
