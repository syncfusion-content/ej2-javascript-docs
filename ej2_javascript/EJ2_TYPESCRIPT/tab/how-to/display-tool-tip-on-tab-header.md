---
title: "Display tooltip for the Tab component header"
component: "Tab"
description: "This example demonstrates how to display tooltip for the Essential JS 2 Tab component header."
---

# Display tooltip for the Tab component header
...
{% tab template="tab/tooltip-tab-header", es5Template="es5_tooltip_tab_header", sourceFiles="index.ts,index.html" %}
